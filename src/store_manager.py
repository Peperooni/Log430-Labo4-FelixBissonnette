...
counter_highest_spender = Counter('orders/reports/highest-spenders', 'Total calls to /orders/reports/highest-spenders')
...
def get_orders_highest_spending_users():
    ...
    counter_highest_spender.inc()
    rows = get_report_highest_spending_users()
    return jsonify(rows)

counter_best_seller = Counter('orders/reports/best-sellers', 'Total calls to /orders/reports/best-sellers')
